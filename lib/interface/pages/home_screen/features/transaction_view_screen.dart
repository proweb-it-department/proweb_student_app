...
class TransactionViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String amountFormater = NumberFormat(
      '#,##0',
      'ru_RU',
    ).format(double.parse(transaction.amount ?? '0'));
                  ...
                  Column(
                    ...
                    children: [
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              leading: icon != null && color != null
                                  ...
                                  : null,
                              title: Text(
                                'transactions_balance.payment_for_a_lesson'
                                    .tr(),
                                style: TextStyle(
                              ...
                              subtitle: Text(
                                'transactions_balance.group_and_lesson_transactions'
                                    .tr(
                                      namedArgs: {
                                        'groupId':
                                            (transaction
                              ...
                              trailing: transaction.canceled == true
                                  ? Container(
                                      ...
                                      child: Text(
                                        'transactions_balance.canseled_transaction_text'
                                            .tr()
                                            .toUpperCase(),
                      ...
                      if (transaction.service != null)
                        ListTileBuilder(
                          isStart: transaction.studentLesson == null,
                          isEnd: false,
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              shape: shape,
                              ...
                              leading: PremiumContainer(
                                text: 'transactions_balance.service_transaction'
                                    .tr(),
                              ),
                              title: Text(
                                'transactions_balance.Payment_for_the_service'
                                    .tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                      ...
                      if (transaction.product != null)
                        ListTileBuilder(
                          isStart:
                              ...
                              transaction.studentLesson == null,
                          isEnd: false,
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              shape: shape,
                              ...
                              tileColor: customColors?.primaryBg,
                              leading: PremiumContainer(
                                text: 'transactions_balance.product_transaction'
                                    .tr(),
                              ),
                              title: Text(
                                'transactions_balance.Payment_for_the_product'
                                    .tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              title: Text(
                                'transactions_balance.Payment_for_the_tariff'
                                    .tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Transaction_number'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Transaction_type'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                              ...
                              subtitle: Text(
                                transaction.type == 'increase'
                                    ? 'transactions_balance.Replenishment'.tr()
                                    : 'transactions_balance.Write_off'.tr(),
                              ),
                            );
                          },
                        ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Check_transaction'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                              ...
                              subtitle: Text(
                                transaction.balanceType == 'main'
                                    ? 'transactions_balance.Main_balance'.tr()
                                    : 'transactions_balance.Voucher_balance'
                                          .tr(),
                              ),
                            );
                          },
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: transaction.type == 'increase'
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Transaction_cancelled'
                                    .tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor,
                                ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Refund'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor,
                                ),
                              ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.Payment_method'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.date_transaction'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                        ...
                        ListTileBuilder(
                          ...
                          builder: (shape, contentPadding, isThreeLine) {
                            return ListTile(
                              ...
                              tileColor: customColors?.primaryBg,
                              title: Text(
                                'transactions_balance.time_transaction'.tr(),
                                style: TextStyle(
                                  color: customColors?.primaryTextColor
                                      .withAlpha(150),
                                ),
                              ...
                              subtitle: Text(
                                '${sl<LocalData>().nulNumber(DateTime.parse(transaction.createdAt!).hour.toDouble())}:${sl<LocalData>().nulNumber(DateTime.parse(transaction.createdAt!).minute.toDouble())}',
                              ),
                            );
                          },
                        ),
