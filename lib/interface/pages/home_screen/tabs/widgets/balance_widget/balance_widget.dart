            ...
            return Padding(
              ...
              child: ClipRRect(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(borderRadius: border, color: Colors.blue.withAlpha(50)),
                  child: Stack(
                    children: [
                      Positioned(
                        ...
                        child: Opacity(
                          ...
                          child: ImageFiltered(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: validBalance ? Colors.blue : Colors.red, borderRadius: BorderRadius.circular(500)),
                      ...
                      Positioned(
                        ...
                        child: RotationTransition(
                          ...
                          child: Opacity(
                            opacity: 1,
                            child: Icon(Icons.wallet, size: MediaQuery.of(context).size.width * 0.7, color: customColors?.containerColor),
                          ),
                        ),
                      ),
                      Positioned(
                          ...
                          child: Column(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text('transactions_balance.Your_balance'.tr(), style: TextStyle(fontSize: 20)),
                                  Text(
                              ...
                              Column(
                                ...
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Text('transactions_balance.Tuition_fees'.tr(), style: TextStyle(fontSize: 16)),
                                  Text('transactions_balance.Payment_in_store'.tr(), style: TextStyle(fontSize: 16)),
                                ],
                              ),
                            ],
                          ),
