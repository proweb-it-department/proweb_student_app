...
class QueueLessonView extends StatelessWidget {
  final GroupLessonInfo lesson;
  final GroupDetail group;
  const QueueLessonView({super.key, required this.lesson, required this.group});
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Icon(Icons.account_tree_rounded, size: 40),
                SizedBox(height: 10),
                Text(
                  'group.video_status_queue'.tr(),
