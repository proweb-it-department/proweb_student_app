...
class DialogMyGroupSelectVideo extends StatefulWidget {
  const DialogMyGroupSelectVideo({super.key});

  @override
  State<DialogMyGroupSelectVideo> createState() =>
      _DialogMyGroupSelectVideoState();
}

class _DialogMyGroupSelectVideoState extends State<DialogMyGroupSelectVideo> {
  MyGroupsItem? _myGroup;

  void setGroup(MyGroupsItem myGroup) {
    setState(() {
      _myGroup = myGroup;
    });
  }
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: myGroups.map((e) {
                              bool accessVideo = false;
                              if (e.accessToVideo != null) {
                                accessVideo = e.accessToVideo!;
                              }
                              return Material(
