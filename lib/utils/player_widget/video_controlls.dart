...
const kDefaultMaterialVideoControlsThemeData = MaterialVideoControlsThemeData(
  bottomButtonBarMargin: EdgeInsets.only(left: 16.0, right: 8.0, bottom: 10.0),
  buttonBarHeight: 56.0,
  buttonBarButtonSize: 24.0,
  controlsHoverDuration: Duration(seconds: 8),
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      width: constraints.maxWidth,
                      height: _theme(context).seekBarHeight + 3,
  ...
  Widget build(BuildContext context) {
    if (!_theme(context).automaticallyImplySkipNextButton ||
      ...
      return IconButton(
        ...
        icon: icon ?? const Icon(Icons.skip_next, color: Colors.white),
  ...
  Widget build(BuildContext context) {
    if (!_theme(context).automaticallyImplySkipPreviousButton ||
      ...
      return IconButton(
        ...
        icon: icon ?? const Icon(Icons.skip_previous, color: Colors.white),
        iconSize: iconSize ?? _theme(context).buttonBarButtonSize,
        color: iconColor ?? _theme(context).buttonBarButtonColor,
      );
    }
