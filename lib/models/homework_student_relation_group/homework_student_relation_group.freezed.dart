...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,createdAt,updatedAt,createdBy,updatedBy,id,score,checked,checkedAt,deadlineLessonNumber,studentId,materialDeleted,student,homework,const DeepCollectionEquality().hash(homeworkMaterials),deadlineExpired,checkExpired,hasMaterial,retakeCheckExpired,lastLessonNumber,checkDeadlineLessonNumber,checkedRetakenAt]);

@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'HomeworkStudentRelationGroup(createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy, id: $id, score: $score, checked: $checked, checkedAt: $checkedAt, deadlineLessonNumber: $deadlineLessonNumber, studentId: $studentId, materialDeleted: $materialDeleted, student: $student, homework: $homework, homeworkMaterials: $homeworkMaterials, deadlineExpired: $deadlineExpired, checkExpired: $checkExpired, hasMaterial: $hasMaterial, retakeCheckExpired: $retakeCheckExpired, lastLessonNumber: $lastLessonNumber, checkDeadlineLessonNumber: $checkDeadlineLessonNumber, checkedRetakenAt: $checkedRetakenAt)';
}
...
@useResult
$Res call({
@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'updated_at') String? updatedAt,@JsonKey(name: 'created_by') UserIdDefault? createdBy,@JsonKey(name: 'updated_by') UserIdDefault? updatedBy,@JsonKey(name: 'id') int? id,@JsonKey(name: 'score') int? score,@JsonKey(name: 'checked') bool? checked,@JsonKey(name: 'checked_at') String? checkedAt,@JsonKey(name: 'deadline_lesson_number') int? deadlineLessonNumber,@JsonKey(name: 'student_id') int? studentId,@JsonKey(name: 'material_deleted') bool? materialDeleted,@JsonKey(name: 'student') Student? student,@JsonKey(name: 'homework') Homework? homework,@JsonKey(name: 'homework_materials') List<HomeworkMaterials>? homeworkMaterials,@JsonKey(name: 'deadline_expired') bool? deadlineExpired,@JsonKey(name: 'check_expired') bool? checkExpired,@JsonKey(name: 'has_material') bool? hasMaterial,@JsonKey(name: 'retake_check_expired') bool? retakeCheckExpired,@JsonKey(name: 'last_lesson_number') int? lastLessonNumber,@JsonKey(name: 'check_deadline_lesson_number') int? checkDeadlineLessonNumber,@JsonKey(name: 'checked_retaken_at') String? checkedRetakenAt
});
...
as bool?,hasMaterial: freezed == hasMaterial ? _self.hasMaterial : hasMaterial // ignore: cast_nullable_to_non_nullable
...
class _HomeworkStudentRelationGroup with DiagnosticableTreeMixin implements HomeworkStudentRelationGroup {
  const _HomeworkStudentRelationGroup({@JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'created_by') this.createdBy, @JsonKey(name: 'updated_by') this.updatedBy, @JsonKey(name: 'id') this.id, @JsonKey(name: 'score') this.score, @JsonKey(name: 'checked') this.checked, @JsonKey(name: 'checked_at') this.checkedAt, @JsonKey(name: 'deadline_lesson_number') this.deadlineLessonNumber, @JsonKey(name: 'student_id') this.studentId, @JsonKey(name: 'material_deleted') this.materialDeleted, @JsonKey(name: 'student') this.student, @JsonKey(name: 'homework') this.homework, @JsonKey(name: 'homework_materials') final  List<HomeworkMaterials>? homeworkMaterials, @JsonKey(name: 'deadline_expired') this.deadlineExpired, @JsonKey(name: 'check_expired') this.checkExpired, @JsonKey(name: 'has_material') this.hasMaterial, @JsonKey(name: 'retake_check_expired') this.retakeCheckExpired, @JsonKey(name: 'last_lesson_number') this.lastLessonNumber, @JsonKey(name: 'check_deadline_lesson_number') this.checkDeadlineLessonNumber, @JsonKey(name: 'checked_retaken_at') this.checkedRetakenAt}): _homeworkMaterials = homeworkMaterials;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,createdAt,updatedAt,createdBy,updatedBy,id,score,checked,checkedAt,deadlineLessonNumber,studentId,materialDeleted,student,homework,const DeepCollectionEquality().hash(_homeworkMaterials),deadlineExpired,checkExpired,hasMaterial,retakeCheckExpired,lastLessonNumber,checkDeadlineLessonNumber,checkedRetakenAt]);
