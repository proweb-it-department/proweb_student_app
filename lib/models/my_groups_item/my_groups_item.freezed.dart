...
@useResult
$Res call({
@JsonKey(name: 'created_at') String? createdAt,@JsonKey(name: 'updated_at') String? updatedAt,@JsonKey(name: 'created_by') UserIdDefault? createdBy,@JsonKey(name: 'updated_by') UserIdDefault? updatedBy,@JsonKey(name: 'group_user_id') int? groupUserId,@JsonKey(name: 'user_id') int? userId,@JsonKey(name: 'status', unknownEnumValue: StudentStatus.unknown) StudentStatus? status,@JsonKey(name: 'payment_type') StudentPaymentType? paymentType,@JsonKey(name: 'group_role') String? groupRole,@JsonKey(name: 'format') String? format,@JsonKey(name: 'lead_id') int? leadId,@JsonKey(name: 'auto_activate_lesson') int? autoActivateLesson,@JsonKey(name: 'middle_rating') String? middleRating,@JsonKey(name: 'coworking_access_last_date') String? coworkingAccessLastDate,@JsonKey(name: 'user') UserIdDefault? user,@JsonKey(name: 'video_access_last_date') String? videoAccessLastDate,@JsonKey(name: 'group') Group? group,@JsonKey(name: 'prices') List<Prices>? prices,@JsonKey(name: 'notifications') List<Notifications>? notifications,@JsonKey(name: 'has_package') bool? hasPackage,@JsonKey(name: 'access_to_video') bool? accessToVideo
});
